...
- Clean and minimal REST endpoints  
- Built using Django and Django REST Framework  
- Serves as a starter backend for a to-do web app

---

## **Purpose**
MyDay API is a student project intended to help reinforce:
- CRUD operations  
- API endpoint structure  
- Request/response flow  
- DRF serializer and view patterns  
...
More detailed documentation, setup instructions, and endpoint descriptions may be added as the project grows.
